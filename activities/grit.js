/* =====================================================================
   ...
   The three self-check questions and the self-talk swap are the course's
   own; the Dweck and Duckworth points are stated the way the course
...
YNSActivity.define({
  ...
  slots: [
    ...
    /* ---------------------------------------------------------------
       2. The course's three self-check questions, one screen. Closed
    ...
    /* ---------------------------------------------------------------
       3. What they did next. Closed vocabulary, no judgment on any
